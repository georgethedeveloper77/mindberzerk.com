...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PackInfo {
      ...
      return PackInfo(packId, packType, title, summary, version, installedVersion, sizeBytes, state, unlocked, sku)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
