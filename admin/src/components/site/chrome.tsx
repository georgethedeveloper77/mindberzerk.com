...
export function Brand() {
  return (
    <a href="#top" className="flex items-center gap-2.5 text-[17px] font-bold tracking-tight text-site-ink">
      <span
        aria-hidden
      ...
      >
        <span className="absolute inset-2 rounded-[4px] bg-site-page" />
      </span>
      Mindberzerk
    </a>
  );
...
export function StoreBadges() {
  return (
    <div className="flex flex-wrap gap-3.5">
      <a
        href={PLAY_DEV_URL}
        className="flex items-center gap-3 rounded-[14px] border border-white/10 bg-[#1c1526] px-[18px] py-2.5 text-white shadow-site-lift transition hover:-translate-y-px hover:bg-[#2a2138]"
      >
        <PlayGlyph />
...
export function Nav() {
  return (
    <nav className="sticky top-0 z-40 border-b border-site-line/70 bg-site-page/85 backdrop-blur-md">
      <div className="mx-auto flex h-[72px] max-w-[1180px] items-center gap-9 px-7">
        <Brand />
        <div className="hidden gap-7 text-[14.5px] font-semibold text-site-ink-3 sm:flex">
          <a className="transition hover:text-site-ink" href="#apps">Apps</a>
          <a className="transition hover:text-site-ink" href="#next">What&apos;s next</a>
          <a className="transition hover:text-site-ink" href="#contact">Contact</a>
        </div>
        <div className="flex-1" />
        <ThemeToggle />
        <a
          href="#contact"
          className="rounded-full bg-site-solid px-[18px] py-2.5 text-sm font-semibold text-site-solid-ink shadow-site-lift transition hover:-translate-y-px hover:bg-site-solid-hover"
        >
          Work with us
        </a>
      </div>
...
export function Footer() {
  return (
    <footer className="border-t border-site-line py-10">
      <div className="mx-auto flex max-w-[1180px] flex-wrap items-center gap-7 px-7 text-sm font-medium text-site-ink-3">
        <Brand />
        <span>© 2026 Mindberzerk</span>
        <div className="flex-1" />
        <a className="transition hover:text-site-ink" href={PLAY_DEV_URL}>Google Play</a>
        <a className="transition hover:text-site-ink" href={APP_STORE_DEV_URL}>App Store</a>
        <a className="transition hover:text-site-ink" href="#contact">Contact</a>
      </div>
    </footer>
  );
