...
> **Where this lives.** `admin/docs/<app>/architecture.md`, inside the panel
> rather than at the repo root, because the panel RENDERS it at
> `/apps/<app>/architecture`. App Hosting deploys the `admin/` directory only,
> so a doc outside it would render locally and 404 in production.
>
